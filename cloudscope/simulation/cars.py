...
running a CloudScope simulation using a known environment/tutorial.
...
from cloudscope.dynamo import Sequence, Uniform
from cloudscope.simulation import Process, NamedProcess
